t <html><head><title>Parametrs RCI</title>
...
t на нижней и верхней граничных частотах и ЦНРК регистратора</h2>
t </tr>
t <table border=0 width=715px>
t <tr bgcolor=#aaccff>
t  <th width=5%>Канал</th><th width=20%>К.п НЧ</th><th width=20%>К.п ВЧ</th>
t  <th width=20%>ЦНРК,В</th>
t </tr>
c n b
t </table>
t <form action=index.htm method=post name=form2>
t <input type=hidden value="yes" name=eeprom>
t <p align="center">
