...
t <br>
#
t <table border=0 width=60%><font size="3">
t <tr style="background-color: #aaffcc">
#
t <td><IMG SRC=pabb.gif>Период колебаний маятника ТБСЦ6, мс</td>
t <td align="left"><input type="text" readonly style="background-color: transparent; border: 0px"
c d 1  size="10" id="sd_value4" value="%6.2f "></td></tr>
t </table>
#
t <table border=0 width=99%><font size="3">
t <tr style="background-color: #aaffcc">
t <td><IMG SRC=pabb.gif>Центровка маятника, %</td>
#
...
t sdVal4 = document.getElementById("sd4_value").value;
t }
#  
